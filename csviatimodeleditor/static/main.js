...
var DEFAULT_FIELD_SETUP, DEFAULT_MODEL, DIMENSION_META, Delegator, DimensionWidget, DimensionsWidget, FIELDS_META, ModelEditor, SAMPLE_DATA, UniqueKeyWidget, Widget, key, util, value, _ref, _ref1, _ref2,
  __slice = [].slice,
...
Widget = (function(_super) {
  ...
  function Widget() {
    _ref1 = Widget.__super__.constructor.apply(this, arguments);
    return _ref1;
  }
...
UniqueKeyWidget = (function(_super) {
  ...
  function UniqueKeyWidget() {
    _ref2 = UniqueKeyWidget.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
  ...
  UniqueKeyWidget.prototype.deserialize = function(data) {
    var availableKeys, fk, fv, k, uniq, v, _ref3, _ref4, _ref5;
    uniq = ((_ref3 = data['dataset']) != null ? _ref3['unique_keys'] : void 0) || [];
    availableKeys = [];
    _ref4 = data['mapping'];
    for (k in _ref4) {
      v = _ref4[k];
...
DimensionWidget = (function(_super) {
  ...
  DimensionWidget.prototype.deserialize = function(data) {
    var formObj, k, v, _ref3, _ref4, _ref5, _results;
    ...
    _ref5 = util.flattenObject(formObj);
    _results = [];
    for (k in _ref5) {
      v = _ref5[k];
  ...
  DimensionWidget.prototype.formFieldRequired = function(fieldName, fieldParent) {
    var _ref3;
    if (fieldParent) {
      return ((_ref3 = FIELDS_META[fieldName]) != null ? _ref3['required'] : void 0) || false;
    } else {
      return false;
    }
  };
  ...
  DimensionWidget.prototype.doIATIFieldSample = function(dimension_name, dimension_data, thiscolumn) {
    var construct_iatifield, k, samplevalue, textdata, v, _ref3;
    construct_iatifield = '<' + dimension_data[dimension_name]['iati-field'];
    _ref3 = dimension_data[dimension_name]['fields'];
    for (k in _ref3) {
      v = _ref3[k];
      if (k === 'text') {
...
DimensionsWidget = (function(_super) {
  ...
  DimensionsWidget.prototype.onCopyDimensionClick = function(e) {
    var data, fieldset, name, widget, _i, _len, _ref3;
...
ModelEditor = (function(_super) {
  ...
  function ModelEditor(element, options) {
    ...
    other_multiples = (function() {
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        x = _ref3[_i];
        if (!(__indexOf.call(common_multiples, x) >= 0)) {
          _results.push(x);
        }
      }
      return _results;
    ...
    $('#multiple_rows_selector').html('Common choices:<br/>' + ((function() {
      var _i, _len, _results;
      _results = [];
      for (_i = 0, _len = common_multiples.length; _i < _len; _i++) {
        x = common_multiples[_i];
      ...
      var _i, _len, _results;
      _results = [];
      for (_i = 0, _len = other_multiples.length; _i < _len; _i++) {
        x = other_multiples[_i];
        if (x !== '') {
          _results.push("<input type='checkbox' name='organisation[data-structure][multiple][]' value='" + x + "'/> Multiple " + x + " rows per activity<br/>");
        }
      }
    ...
    for (selector in _ref3) {
      ctor = _ref3[selector];
      _ref4 = this.element.find(selector).get();
