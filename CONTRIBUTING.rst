If you would like to contribute to the CSV2IATI project, you can....
...
========================================
If you are able to work with GitHub then please "Create an issue". The issue tracker for CSV2IATI is used to log issues for both this code and the CSV2IATI-backend code.
